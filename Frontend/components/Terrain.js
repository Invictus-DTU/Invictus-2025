    ...
    <div className={"fixed bottom-0 left-0 w-full -z-10 md:-z-0 flex flex-col -space-y-9 items-center"}>
      ...
      <div className={'flex justify-center items-end gap-10 z-0'}>
        ...
        <img src="/bonsai-right.svg" alt="first" className={cn(
          ...
          (path === "/comingsoon" || path === "/events" || path === "/workshops") && "-left-40",
          (path === "/team" || path === "/login" || path === "/signup") && "-left-48",
          path === "/sponsors" && "lg:left-[3%] xl:left-[6%]",
          )} />
          
        <img src="/bonsai-left.svg" alt="second" className={cn(
          "w-24 absolute left-[10%] bottom-16 duration-1000 hidden lg:block",
          (path === "/comingsoon" || path === "/events" || path === "/workshops") && "left-6",
          (path === "/team" || path === "/login" || path === "/signup") && "-left-48",
        ...
        <img src="/twintower.svg" alt="" className={cn(
          ...
          (path === "/comingsoon" || path === "/events" || path === "/workshops") && "w-40 bottom-14 sm:-left-48 md:-left-10 lg:left-[9%]",
          (path === "/team" || path === "/login" || path === "/signup") && "sm:-left-48 md:-left-48 lg:-left-48",
        ...
        <img src="/bonsai-left.svg" alt="third" className={cn(
          ...
          (path === "/comingsoon" || path === "/events" || path === "/workshops") && "-left-5 sm:-left-5 md:left-[13.5%] lg:left-[23%]",
          (path === "/team" || path === "/login" || path === "/signup") && "sm:-left-48 md:-left-8 lg:left-[1%] xl:left-[1%]",
        ...
        <img src="/dtu_gate2.png" alt="" className={cn(
          ...
          (path === "/team" || path === "/login" || path === "/signup") && "sm:-left-20 md:left-[6%] lg:left-[5%] xl:left-[10%]",
        ...
        <img src="/bonsai-right.svg" alt="forth" className={cn(
          ...
          (path === "/comingsoon" || path === "/events" || path === "/workshops") && "-right-5 sm:right-[52%] md:right-[43%] lg:right-[45%]",
          (path === "/team" || path === "/login" || path === "/signup") && "sm:right-[82%] md:right-[71%] lg:right-[77%] xl:right-[74%]",
        ...
        <img src="/bonsai-left.svg" alt="fifth" className={cn(
          ...
          (path === "/comingsoon" || path === "/events" || path === "/workshops") && "right-[33%]",
          (path === "/team" || path === "/login" || path === "/signup") && "lg:right-[67%] xl:right-[64%]",
        ...
        <img src="/tnpblock1.png" alt="" className={cn(
          ...
          (path === "/comingsoon" || path === "/events" || path === "/workshops") && "w-3/4 sm:w-[49%] md:w-[40%] lg:w-[30%] bottom-[3.5rem] left-auto right-auto sm:right-[1rem]",
          (path === "/team" || path === "/login" || path === "/signup") && "bottom-[4rem] sm:right-[60%] md:right-[53%] lg:right-[53%] xl:right-[51%]",
        ...
        <img src="/bonsai-right.svg" alt="sixth" className={cn(
          ...
          (path === "/team" || path === "/login" || path === "/signup") && "right-[42%]",
        ...
        <img src="/bonsai-left.svg" alt="seventh" className={cn(
          ...
          (path === "/team" || path === "/login" || path === "/signup") && "sm:right-[49%] md:right-[41%] lg:right-[32%] xl:right-[34%]",
          path === "/sponsors" && "md:right-0 lg:-right-16 xl:-right-7",
          )} />

        <img src="/twintower.svg" alt="" className={cn(
          "w-48 brightness-0 duration-1000 absolute bottom-12 -right-48",
          (path === "/team" || path === "/login" || path === "/signup") && "w-[100%] sm:w-[75%] md:w-[60%] lg:w-[47%] xl:w-[45%] -bottom-4 -right-2 sm:-right-24 md:-right-[6.5rem] lg:-right-24 xl:-right-24",
          )} />
      </div>
