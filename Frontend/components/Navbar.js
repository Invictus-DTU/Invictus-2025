  ...
  return (
    <div className='relative z-[11] md:z-auto'>
      <div className='justify-between gap-12 fixed w-full px-5 hidden md:flex z-20'>
        ...
        <div className='absolute -top-[20rem] right-5 duration-500 scale-90 hover:scale-[1.05] hover:-top-[23rem]]'>
          <Link href="/login">
            <button onClick={() => setLoginPopUp(true)} className={cn(
              'relative ')}>
              <img src="/fullscroll1.svg" />
              <p className="absolute bottom-[20px] left-10 right-0 z-10 text-black font-medium text-lg">
                Login
              </p>
            </button>
          </Link>
